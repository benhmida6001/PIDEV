...
public class RechercherEvenementsParCritereController {
    
    @FXML
    private TextField critereField;
    ...
    public RechercherEvenementsParCritereController() {
    ...
    private void handleRechercher(ActionEvent event) {
        String critere = critereField.getText().trim();
        ...
        try {
            // Rechercher les événements par critère
            List<Evenement> evenements = evenementService.rechercherEvenementsParCritere(critere);
            ...
            if (evenements.isEmpty()) {
                ...
                messageLabel.setText("Aucun événement trouvé pour: " + critere);
            } else {
    ...
    private void handleRetour(ActionEvent event) {
        try {
            ...
            Stage stage = (Stage) critereField.getScene().getWindow();
