-- Fix evenement table - handle both creation and column updates
USE pidev;
...
-- Create evenement table with correct camelCase column names
...
SELECT 'EVENEMENT TABLE STRUCTURE:' as info;
DESCRIBE evenement;

SELECT 'PARTICIPATION TABLE STRUCTURE:' as info;
DESCRIBE participation;

-- Verify sample data
SELECT 'SAMPLE EVENT DATA:' as info;
SELECT idEvent, nomEvent, dateEvent, lieuEvent, capaciteMax, pointsOfferts, statut FROM evenement;

SELECT 'SAMPLE PARTICIPATION DATA:' as info;
SELECT * FROM participation;

-- Test the exact query used in EvenementService
SELECT 'TESTING EVENEMENT SERVICE QUERY:' as info;
SELECT * FROM evenement ORDER BY dateEvent ASC;
