 ...
 */
final class Version20260220185749 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, profile_picture, nom, prenom, adresse, age, sexe, roles, password FROM "user"');
        ...
        $this->addSql('INSERT INTO "user" (id, email, profile_picture, nom, prenom, adresse, age, sexe, roles, password) SELECT id, email, profile_picture, nom, prenom, adresse, age, sexe, roles, password FROM __temp__user');
